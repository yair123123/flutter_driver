...
abstract class $GroupCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<Ride> rides});
}
...
class _$GroupCopyWithImpl<$Res, $Val extends Group>
  ...
  @override
  $Res call({Object? id = null, Object? name = null, Object? rides = null}) {
    return _then(
      _value.copyWith(
            id:
                null == id
...
class _$GroupImpl implements _Group {
  const _$GroupImpl({
    required this.id,
    required this.name,
    required final List<Ride> rides,
  }) : _rides = rides;
  ...
  @override
  String toString() {
    return 'Group(id: $id, name: $name, rides: $rides)';
  }
